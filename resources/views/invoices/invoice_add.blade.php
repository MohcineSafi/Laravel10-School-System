                                    ...
                                    <div class="col-xl-4 col-md-6 col-sm-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <select class="select select2s-hidden-accessible" style="width: 100%;"
                                                tabindex="-1" aria-hidden="true" id="customer_name"
                                                name="customer_name">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control @error('po_number') is-invalid @enderror"
                                                type="text" id="po_number" name="po_number"
                                                placeholder="Enter Reference Number" value="{{ old('po_number') }}">
                                        </div>
                                    </div>
                                                        ...
                                                        <div class="invoice-inner-date">
                                                            <span>
                                                                Date <input class="form-control datetimepicker"
                                                                    type="text" name="date" value="{{ date('d-m-Y') }}">
                                                            </span>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 col-md-6">
                                                        <div class="invoice-inner-date invoice-inner-datepic">
                                                            <span>
                                                                Due Date <input
                                                                    class="form-control datetimepicker @error('po_number') is-invalid @enderror"
                                ...
                                <div class="row">
                                    <div class="col-xl-4 col-lg-6 col-md-6">
                                        <div class="invoice-info">
                                            ...
                                            <textarea rows="1.5" class="form-control" name="invoice_from">Mohcine Kh
#61, Preah Monivong Blvd., Penh, Cambodia.</textarea>
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-6">
                                        <div class="invoice-info">
                                            ...
                                            <textarea rows="1.5" class="form-control" name="invoice_to">Mohcine Kh
                            ...
                            <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="auto_account_number"
                                                    ...
                                                    <div id="collapseTwo" class="panel-collapse collapse"
                                                        ...
                                                        <div class="panel-body">
                                                            <textarea class="form-control"
                                                                name="add_terms_and_conditions"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="col-lg-5 col-md-6">
                                    <div class="invoice-total-card">
                                        ...
                                        <div class="invoice-total-box">
                                            <div class="invoice-total-inner">
                                                ...
                                                <p>Round Off
                                                    <input type="checkbox" name="round_off" id="status_1" class="check"
                                                        value="54">
                                            ...
                                            <div class="invoice-total-footer">
                                                <h4>Total Amount <span id="total_amount">$<span
                                                            class="total_amount">00</span></span></h4>
                                    ...
                                    <div class="upload-sign">
                                        ...
                                        <div class="form-group">
                                            <input type="text"
                                                class="form-control @error('name_of_the_signatuaory') is-invalid @enderror"
                                                name="name_of_the_signatuaory" placeholder="Name of the Signatuaory">
                                        </div>
...
$(document).on("click", ".add-btn", function() {
    var experiencecontent =
        '<tr class="add-row">' +
        '<td>' +
        '<input type="text" class="form-control @error("items.*") is-invalid @enderror" name="items[]">' +
        '</td>' +
